<h3 align="center">TryHackMe - DAV CTF</h3>
...
Ok, so we have only  the port 80 open without any relevant information, but assuming the name of the CTF is DAV, I immediately tried to access the directory /webdav/ service and it exists!
But it requires login..


<img width="415" height="213" alt="image" src="https://github.com/user-attachments/assets/cd3c438c-e1be-40c7-9934-c58245eba9b8" />

Before we try to get the credentials, I tried to run a directory enumeration with gobuster and see if there was any other page on this address.
...
I tried to capture the login request with BurpSuite tool, to start a brute-forcing, but the results don't even show the user and password as basic authorization was enabled.
...
<img width="518" height="196" alt="image" src="https://github.com/user-attachments/assets/10559a93-2c18-4b51-9e25-6e1dc4b056b5" />
